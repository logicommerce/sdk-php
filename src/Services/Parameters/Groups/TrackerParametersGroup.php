...
use SDK\Services\Parameters\Validators\TrackerParametersValidator;
 ...
 */
class TrackerParametersGroup extends ParametersGroup {
     ...
     */
    protected function getValidator(): TrackerParametersValidator {
        return new TrackerParametersValidator();
    }
}
