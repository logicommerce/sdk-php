...
use SDK\Services\Parameters\Validators\Basket\EditBasketCustomTagParametersValidator;
 ...
 */
class EditBasketCustomTagParametersGroup extends ParametersGroup {
    ...
    /**
     * Sets the custom tag id parameter for this parameters group.
     *
     ...
     */
    protected function getValidator(): EditBasketCustomTagParametersValidator {
        return new EditBasketCustomTagParametersValidator();
    }
}
