...
use SDK\Services\Parameters\Validators\Account\RegisteredUserParametersValidator;

/**
 * This is the registered user parameters group class.
 *
 * @package SDK\Services\Parameters\Groups\Account
 */
class RegisteredUserParametersGroup extends ParametersGroup {
     ...
     */
    protected function getValidator(): RegisteredUserParametersValidator {
        return new RegisteredUserParametersValidator();
    }
}
