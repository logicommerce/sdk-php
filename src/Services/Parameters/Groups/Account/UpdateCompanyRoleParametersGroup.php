...
use SDK\Services\Parameters\Validators\Account\UpdateCompanyRolesParametersValidator;

/**
 *  Class to update a company role.
 *
 * @package SDK\Services\Parameters\Groups\Account
 */
class UpdateCompanyRoleParametersGroup extends ParametersGroup {
     ...
     */
    protected function getValidator(): UpdateCompanyRolesParametersValidator {
        return new UpdateCompanyRolesParametersValidator();
    }
}
