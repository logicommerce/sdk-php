...
use SDK\Services\Parameters\Validators\Account\UpdateRegisteredUserParametersValidator;

/**
 * This is the account model (registered user update resource) parameters group class.
 *
 * @package SDK\Services\Parameters\Groups\Account
 */
class UpdateRegisteredUserParametersGroup extends ParametersGroup {
     ...
     */
    protected function getValidator(): UpdateRegisteredUserParametersValidator {
        return new UpdateRegisteredUserParametersValidator();
    }
}
