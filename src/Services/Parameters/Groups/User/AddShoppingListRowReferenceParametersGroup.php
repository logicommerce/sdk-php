...
use SDK\Services\Parameters\Validators\User\AddShoppingListRowReferenceParametersValidator;

/**
 * This is the add shopping list row reference parameters group class.
 *
 * @package SDK\Services\Parameters\Groups\User
 */
class AddShoppingListRowReferenceParametersGroup extends ParametersGroup {
     ...
     */
    protected function getValidator(): AddShoppingListRowReferenceParametersValidator {
        return new AddShoppingListRowReferenceParametersValidator();
    }
}
