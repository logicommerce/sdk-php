...
use SDK\Services\Parameters\Validators\ContactParametersValidator;
 ...
 */
class ContactParametersGroup extends ParametersGroup {
     ...
     * @return void
     */
    public function setMotiveId(int $motiveId): void {
     ...
     */
    protected function getValidator(): ContactParametersValidator {
        return new ContactParametersValidator();
    }
}
