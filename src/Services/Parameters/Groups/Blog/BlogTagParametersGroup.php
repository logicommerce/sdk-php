...
use SDK\Services\Parameters\Validators\Blog\BlogTagParametersValidator;
 ...
 */
class BlogTagParametersGroup extends ParametersGroup {
     ...
     */
    protected function getValidator(): BlogTagParametersValidator {
        return new BlogTagParametersValidator();
    }
}
