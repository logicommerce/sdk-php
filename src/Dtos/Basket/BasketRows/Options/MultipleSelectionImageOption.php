 ...
 *
 * @see MultipleSelectionImageOption::getValueList()
 *
 * @see ElementTrait
 *
 * @package SDK\Dtos\Basket\BasketRows\Options
 */
class MultipleSelectionImageOption extends Option {
    use ElementTrait;
    ...
    protected function setValueList(array $valueList): void {
        $this->valueList = $this->setArrayField($valueList, ImageOptionValue::class);
    }
}
