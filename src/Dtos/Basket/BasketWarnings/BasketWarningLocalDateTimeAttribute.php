 ...
 *
 * @see BasketWarningLocalDateTimeAttribute::getValue()
 * @see BasketWarningLocalDateTimeAttribute::getType()
 *
 * @see ElementTrait
 *
 * @package SDK\Dtos\Basket\BasketWarnings
 */
class BasketWarningLocalDateTimeAttribute extends BasketWarningAttribute {
    use ElementTrait;
    ...
    protected function getDefaultType(): string { // ENUM
        return BasketWarningAttributeType::LOCAL_DATE_TIME;
    }
}
