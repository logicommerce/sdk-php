...
/**
 * The rich return document.
 * The rich return document is a document that represents a return merchandise authorization.
 * 
 * @see getVouchers
 ...
 */
class RichReturn extends RichReturnProcessDocument {
