...
/**
 * The rich RMA document.
 * The rich RMA document is a document that represents a return merchandise authorization.
 * 
 * @see getVouchers
 ...
 */
class RichRMA extends RichReturnProcessDocument {
