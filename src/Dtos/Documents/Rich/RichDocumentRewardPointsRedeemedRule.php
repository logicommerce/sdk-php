 ...
 *
 * @see RichDocumentRewardPointsRedeemedRule::getLanguage()
 * @see RichDocumentRewardPointsRedeemedRule::getFrom()
 * @see RichDocumentRewardPointsRedeemedRule::getTo()
 * @see RichDocumentRewardPointsRedeemedRule::getValue()
 * @see RichDocumentRewardPointsRedeemedRule::getType()
 * @see RichDocumentRewardPointsRedeemedRule::getValueMode()
 * @see RichDocumentRewardPointsRedeemedRule::getRedeemed()
 *
 * @see Element
 * 
 * @uses ElementTrait
 ...
 */
class RichDocumentRewardPointsRedeemedRule extends Element{
